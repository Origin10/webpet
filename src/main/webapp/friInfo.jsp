        ...
        <div class="container ">
          ...
          <!--  通知 -->
                    <li class="dropdown"  style="display:none" id="alert">
                        ...
                        <a href="#" class="dropdown-toggle  glyphicon glyphicon-bell" data-toggle="dropdown"><span class="badge" id="alerttotal">0</span></a>
...
<!-- 登入                   -->
	...
	<!-- start header-->
			<div class="header">
				<div class="logo">
				 	 <div class="content"> <h2>Hello You watching&nbsp;&nbsp;  ${mfri.mem_name}</h2> </div> <!--  放會員名字-->
				 	 <div id="mfriid" style="display:none">${mfri.mem_id}</div>
				 	 <div id="mememail" style="display:none">${mem.mem_mail}</div>
				 	 			 <!-- 	style="display:none" -->
<!-- 						<button type="button" id="addfri"   >申請加入好友</button> -->
<!-- 						<button type="button" id="delfri" >移除好友</button>	  -->
						
				</div>
				<div class="cssmenu">
					<ul>
					  	<li class="active"><a href="MemInfo.jsp">Home</a></li>
					  	<li ><a href="#" id="fri">Friend</a></li>
					  	<li><a href="#" id ="think">在想什麼</a></li>
					  			 <!-- 	style="display:none" -->
						<li id="addfri"><a href="#">申請加入好友</a></li>
						<li id="delfri"><a href="#">移除好友(邀請)</a> </li>
						<div class="clear"></div>
					 </ul>
				</div>
				<div class="clear"></div>
		    ...
		    <div class="banner">
		    	<div class="banner-division d_img">
			    	 <img src="${pageContext.servletContext.contextPath}/memPhoto.do?id=${mfri.mem_mail}&type=memPhoto" height="300px" />
			    	<br>
		    	...
		    	<div class="banner-division" id = shareaaa>
<!--會員心情-->
		    	<c:forEach var="share" items="${frishare}">
<%-- 		    	 <h3>${share.share_date}</h3> --%> 	
				<div style="border-width:1px;border-style:dashed;" id="sharediv" >
					<p>${share.share_content}</p>
		    	 	<p id= "${share.share_Id}" style="float: right;">${share.share_date} </p>
				</div>		    	 	
		    	 </c:forEach>
		    		 ...
		    		 <div style="color:blue;font-size: 30px" style="display:none">
                            	<ul id="friul" >
...
<!-- PetINFO 資訊 -->
					 	 <div class="grids_of_4">
					 	 	<c:forEach var="list" items="${fripet}">	
								...
								<div class="grid_1_of_4 images_1_of_4" id="petedit" style="">
...
<!-- start footer copy -->
	...
	var mfriid= $("#mfriid").text();
	var memail = $("#mememail").text();
	
	$(document).ready(function(){
		$.get("frilist",{"id": mfriid },function(){	
		})
		.done(function(responseText){
// 			alert("123responseText: "+responseText);
// 			alert("memail" + memail);
				$.each(responseText, function(index, item) {
					if(item.match(memail)){
							$("#delfri").show();
							$("#addfri").hide();
							alert("YES");
							return false;
	...
	$(document).on("click","#delfri",function(){
		$.get("fristatus",{"id": ${mem.mem_id},"fri":${mfri.mem_id} ,"type":"onlydel" } , function(){			
	...
	$(document).on("click","#addfri",function(){
		$.get("fristatus",{"id": ${mem.mem_id},"fri":${mfri.mem_id} ,"type":"insertinvalid"} , function(){			
		alert("fri: "+ ${mfri.mem_id} + "mid :"+ ${mem.mem_id} );
		})
		.done(function(data){
			if(data){
