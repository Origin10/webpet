    						...
    						<div class="mem-group">
    			  					<label for="pwd">會員InFo:</label>
    			  					 <textarea class="form-control" cols="30" rows="10" name="minfo" placeholder="會員InFo:" id="info">${mem.mem_info}</textarea>
   	  								  ...
   	  								  <button id="sendMemUp"type="submit" class="btn btn-default" name="membutton" value="memUpdate" onclick="doMemset()">修改</button>									 
   	  								  <button type="button" id="Cancel"  class="btn btn-default ">Cancel</button>${mupdate.mInsertError}
  					</form>
  				</div> 
