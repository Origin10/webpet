			...
			<div class="header">
				...
				<div class="cssmenu">
					<ul>
						...
						<li class="active"><a href="${pageContext.servletContext.contextPath}/editMem.jsp" id="showeditMem">個人資料</a></li>
...
<!-- 		 在想什麼 -->
					<form  class="form-inline" action="share.do" method="post" role="form" id="shareform" style="display: none">
                                   	<div class="form-group"id="sharebutton" >
                                   	<textarea class="form-control" cols="60" rows="5" name="contentMsg"></textarea>
...
<!-- 					 <button type="button" id="pCancel" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
    						...
    						<div class="mem-group" style="display: none">
   							...
   							<div class="mem-group" >
     								...
     								<a href="#" id ="chgpwd" onclick= chgpwd()>修改密碼</a> <label>${mupdate.mname}</label>
    						</div> 
    					<div  id="chgform" style="display: none">						
    						<div class="mem-group" >
      								<label>修改密碼:</label>
     								<input type="password" class="form-control"  placeholder="修改密碼:" name="mpwd"  id="pwd">
    						</div>${mupdate.pwd}
    						
    						<div class="mem-group" >
      								<label>確認密碼:</label>
     								<input type="password" class="form-control"  placeholder="確認密碼:" name="mcheckpwd" value="" id ="checkpwd">
    						</div> ${mupdate.ckpwd}
    					</div> 
    						...
    						<div class="mem-group">
  							...
  							<div class="mem-group">
    			  					<label>會員照片:</label>
    			  					<img id="blah"  class="img-circle" src="${pageContext.servletContext.contextPath}/memPhoto.do?id=${mem.mem_mail}&type=memPhoto"  width="80" height="80">
      								<input   type="file" class="form-control" placeholder="choice photo" name="mphoto"  value="${mem.mem_photo}" id="imgInp"> 	
      						</div>
    						...
    						<div class="mem-group">
    								  ...
    								  <button type="button" id="Cancel"  class="btn btn-default pull-right">Cancel</button>${mupdate.mInsertError}
    								  <button id="sendMemUp"type="submit" class="btn btn-default pull-right" name="membutton" value="memUpdate" onclick="doMemset()">修改</button>									 
  					</form>
  					</div>
    			</div>
