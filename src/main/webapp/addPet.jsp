			...
			<div class="header">
				...
				<div class="cssmenu">
					<ul>
						...
						<li class="active"><a href="addPet.jsp">寵物加入家庭</a></li>
				...
				<nav class="clearfix">
						<ul>
							...
							<li><a href="${pageContext.servletContext.contextPath}/editMem.jsp" id="showeditMem">個人資料</a></li>
							<li><a href="FriList.jsp" >Friend</a></li>
							<li class="active"><a href="FriList.jsp">寵物加入家庭</a></li>
							<li><a href="share.jsp">在想什麼</a></li>
						</ul>
    						...
    						<div class="form-group">
    			  					<label for="pwd">寵物InFo:</label>
    			  					 <textarea class="form-control" cols="30" rows="10" name="pet_info" placeholder="寵物InFo:"></textarea>
    						   	  	 ...
    						   	  	 <button type="button" id="Cancel"  class="btn btn-default pull-right">Cancel</button>	${petCRUD.pInsertError}
   	  								 <button type="submit" name="pet" value="addPet" class="btn btn-default pull-right">新增寵物 ${messsage.PinsertError}</button>
  					</form>
			     </div>	
